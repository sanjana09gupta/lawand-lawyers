...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative overflow-hidden bg-brand-950 py-28">
        ...
        <div className="mt-14 grid gap-10 lg:grid-cols-[1fr_1.2fr]">
          <div className="space-y-4">
            ...
            >
              ...
              <div>
                <p className="font-serif text-lg text-white">Opening Hours</p>
          ...
          >
            ...
            <button
              type="submit"
              disabled={sent}
              className="brand-gradient mt-6 flex w-full items-center justify-center gap-2 rounded-full py-4 text-sm font-semibold uppercase tracking-wide text-white transition-opacity hover:opacity-90 disabled:opacity-70"
            >
              {sent ? (
                <>
